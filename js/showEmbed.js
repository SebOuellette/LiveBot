...
let showEmbed = (embed, element, msg) => {
  ...
  if (['rich', 'link'].includes(type)) {
    showMessageEmbed(embed, msg, element, type);
    ...
    showMessageEmbed(embed, msg, element);
  }
};

let showMessageEmbed = (embed, msg, element, type) => {
...
let showArticleEmbed = (embed, msg, element) => {
  ...
  if (embed.description) {
    ...
    description.classList.add('embedDescription');
    description.classList.add('embedContent');
    description.innerHTML = parseMessage(
      embed.description,
      msg,
      true,
      true,
